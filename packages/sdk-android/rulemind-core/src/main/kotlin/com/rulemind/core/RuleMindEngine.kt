...
class RuleMindEngine(
    ...
    fun evaluate(bundle: Bundle, policyId: String, payload: Map<String, Any?>, userId: String? = null): Decision {
        ...
        val decision = policyExecutor.evaluate(bundle, policy, payload)
